...
{
    private ISudokuEngineSettings settings;
    ...
    public Solution(ISudokuEngineSettings settings)
    {
        values = new byte[SudokuGrid.SudokuSize][];
        for(int row = 0; row < SudokuGrid.SudokuSize; row++)
            values[row] = new byte[SudokuGrid.SudokuSize];
        Init();
    ...
    public override void Init()
    {
        ...
        for(row = 0; row < SudokuGrid.SudokuSize; row++)
            for(col = 0; col < SudokuGrid.SudokuSize; col++)
